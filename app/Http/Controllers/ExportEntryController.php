...
class ExportEntryController extends Controller
{
    ...
    private function rules(): array
    {
        return [
            ...
            'extra_materials' => ['nullable', 'array'],
            'extra_materials.*.title' => ['required_with:extra_materials', 'string', 'max:255'],
            'extra_materials.*.quantity' => ['required_with:extra_materials', 'numeric', 'min:0'],
